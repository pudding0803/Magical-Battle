...
public class Arrow extends SkillObject {
    ...
    public Arrow(Player player, boolean isLeft, boolean fromPlayer1) {
        ...
        int fixedPositionY = new Random().nextInt(31) - 15;
        int fixedVelocityX = new Random().nextInt(5) - 1;
        ...
        this.damage = player.getAttack() * 0.24;
        this.fromPlayer1 = fromPlayer1;
        this.attackBoth = false;
        this.gravity = false;
        this.velocityX = (Settings.ATTACK_VELOCITY + fixedVelocityX) * (isLeft ? -1 : 1);
        this.velocityY = 0;
    }
