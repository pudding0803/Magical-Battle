...
public class Ice extends SkillObject {
    ...
    public Ice(Player player, boolean isLeft, boolean fromPlayer1) {
        Image left = new Image(Objects.requireNonNull(getClass().getResource(assetsFilePath + "attack/left/ice.png")).toExternalForm());
        Image right = new Image(Objects.requireNonNull(getClass().getResource(assetsFilePath + "attack/right/ice.png")).toExternalForm());
        this.fireMedia = new AudioClip(Objects.requireNonNull(getClass().getResource(assetsFilePath + "media/fire/ice.mp3")).toExternalForm());
        this.hitMedia = new AudioClip(Objects.requireNonNull(getClass().getResource(assetsFilePath + "media/hit/ice.mp3")).toExternalForm());
