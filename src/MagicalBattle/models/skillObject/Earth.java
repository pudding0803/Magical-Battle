...
public class Earth extends SkillObject {
    ...
    public Earth(Player player, boolean isLeft, boolean fromPlayer1) {
        Image left = new Image(Objects.requireNonNull(getClass().getResource(assetsFilePath + "attack/left/earth.png")).toExternalForm());
        Image right = new Image(Objects.requireNonNull(getClass().getResource(assetsFilePath + "attack/right/earth.png")).toExternalForm());
        this.fireMedia = new AudioClip(Objects.requireNonNull(getClass().getResource(assetsFilePath + "media/fire/earth.mp3")).toExternalForm());
        this.hitMedia = new AudioClip(Objects.requireNonNull(getClass().getResource(assetsFilePath + "media/hit/earth.mp3")).toExternalForm());
